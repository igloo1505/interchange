...
const posts = [
	...
	},
	{
		...
		description:
			'<p>Spectrum News 1 Reporter Katarina Velazquez recently reported on the food pantry and our efforts to provide fresh fruits and vegetables to our guests.</p><p>Interchange Food Pantry and our dedicated volunteers were recently featured in a story from Spectrum News 1 Milwaukee on the impact of rising food prices.</p><blockquote><p>“A Milwaukee food pantry that serves high-quality food to its guests asking for community help. The Interchange Food Pantry is fundraising, hoping to keep up with the rising prices of fresh foods and the demand from the community…</p><p>‘With the food prices going up… it’s really affecting our guests to not be able to afford what they really need,’ said pantry director George Neureuther.“</p></blockquote><p>Watch and share the full story here: <a target="_blank" rel="noopener noreferrer nofollow" href="https://bit.ly/3KuqO63">https://bit.ly/3KuqO63</a></p><p>And if able, support our efforts with a donation: <a target="_blank" rel="noopener noreferrer nofollow" href="https://gofund.me/f827bfe0">https://gofund.me/f827bfe0</a></p>',
	},
	{
